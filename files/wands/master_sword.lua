...
local gun = { }
gun.name = {"Master Sword"}
gun.deck_capacity = {3,5}
...
AddGunActionPermanent( entity_id, "OVERCAST_HOLOBLADE_MASTER" )
...
ComponentSetValue2( item_comp, "item_name", "Master Sword" )
