...
local range = 300
local steering_strength = 1 -- how much to lerp towards target (0...1)
...
ComponentObjectSetValue2(comp, "damage_by_type", "melee", melee - 0.2)
...
ComponentSetValue2( comp, "air_friction", -1.5)
