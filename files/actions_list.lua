...
overcast_actions = {
	...
	},
	{
		...
		name 		= "Poly Payload",
		description = "Makes a projectile drop some polymorphine upon contact",
	...
	},
	{
		...
		description = "A deadly dart tipped with a poisonous curse",
	...
	},
	{
		...
		description = "A deadly dart tipped with a poisonous curse, and casts another spell upon collision",
	...
	},
	{
		...
		description = "Fires small black holes capable of eating through terrain, and casts another spell upon expiring",
	...
	},
	{
		...
		description = "Prismatic orbs that deal 13 damage of a random damage type, and casts another spell upon impact",
	...
	},
	{
		...
		name 		= "Toinen Kuu",
		description = "Makes your wand repel objects. Does not repel projectiles",
	...
	},
	{
		id          = "OVERCAST_UPGRADE",
		name 		= "Augment",	
		description = "Significantly improves all stats of a projectile",
	...
	},
	{
		...
		name 		= "Bleeding",
		description = "Causes hit entities to bleed for 3 times more blood for some time",
	...
	},
	{
		id          = "OVERCAST_FOLLOW",
		name 		= "Tug",
		description = "Constantly pulls you towards its projectile",
	...
	},]]--
	{
		...
		name 		= "Recharge Amp",
		description = "Increases mana charge speed when you're not casting",
	...
	},]]--
	{
		...
		name 		= "Wand glue",
		description = "Suspends the projectile in front of your wand",
	...
	{
		id          = "OVERCAST_LASER_SIGHT_BACKWARDS",
		name 		= "Purple thgiS resaL?",
		description = "Isn't this... backwards??",
		sprite 		= "mods/cool_spell/files/icons/laser_sight_backwards.png",
		sprite_unidentified = "data/ui_gfx/gun_actions/torch_unidentified.png",
		type 		= ACTION_TYPE_PASSIVE,
		spawn_level                       = "1,2,3,4,5", -- LASER
		spawn_probability                 = "0.5,0.5,0.5,0.5,0.5", -- LASER
		price = 60,
		mana = 0,
		custom_xml_file = "mods/cool_spell/files/actions/laser_sight_backwards.xml",
		action 		= function()
			c.spread_degrees = c.spread_degrees + 3
			draw_actions( 1, true )
		end,
	...
	--[[
	{
		id          = "OVERCAST_DISCO",
		name 		= "Disco",
		description = "8 Lasers come out of your projectile",
		sprite 		= "mods/cool_spell/files/icons/nosprite.png",
		sprite_unidentified = "data/ui_gfx/gun_actions/electric_charge_unidentified.png",
		related_extra_entities = { "mods/cool_spell/files/actions/disco.xml" },
		type 		= ACTION_TYPE_MODIFIER,
		spawn_level                       = "3,4,5,6,10",
		spawn_probability                 = "0.3,0.5,1,0.8,1",
		price = 140,
		mana = 15,
		action 		= function()
			c.extra_entities = c.extra_entities .. "mods/cool_spell/files/actions/disco.xml,"
			--c.damage_melee_add = c.damage_melee_add + 0.2
			draw_actions( 1, true )
		end,
	},]]-- --functional, somewhat already exists in vanilla
}
